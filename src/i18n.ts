...
export type TranslationKey =
  ...
  | 'normalisation' | 'unchanged' | 'nfc' | 'nfd' | 'unchangedInfo' | 'nfcInfo' | 'nfdInfo' | 'area' | 'bottom' | 'top' | 'left' | 'right'
...
const turkish: Record<TranslationKey, string> = {
  ...
  normalisation: 'Normalleştirme', unchanged: 'Değiştirme', nfc: 'NFC', nfd: 'NFD', unchangedInfo: 'Metne normalleştirme uygulamaz. Mevcut kod noktaları, girildikleri sırayla korunur.', nfcInfo: 'Mevcut metni NFC ile normalleştirir. Eşdeğer dizileri mümkün olduğunda önceden oluşturulmuş biçimde birleştirir; görünüm aynı kalabilir, kod noktaları değişebilir.', nfdInfo: 'Mevcut metni NFD ile normalleştirir. Önceden oluşturulmuş karakterleri temel karakter ve birleştirici işaretlerine ayırır; görünüm aynı kalabilir, kod noktaları değişir.', area: 'Alan', bottom: 'Alt', top: 'Üst', left: 'Sol', right: 'Sağ',
...
const english: Record<TranslationKey, string> = {
  ...
  normalisation: 'Normalisation', unchanged: 'Unchanged', nfc: 'NFC', nfd: 'NFD', unchangedInfo: 'Makes no normalisation change. The existing code-point sequence stays exactly as entered.', nfcInfo: 'Applies NFC to the current text. Canonically equivalent sequences are combined when Unicode defines a composed form; the display may stay the same while code points change.', nfdInfo: 'Applies NFD to the current text. Composed characters are split into a base character and combining marks; the display may stay the same while code points change.', area: 'Palette placement', bottom: 'Bottom', top: 'Top', left: 'Left', right: 'Right',
